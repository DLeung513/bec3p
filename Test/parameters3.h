...
// different values are needed. Assuming a boson mass of 1e-26 eV ~ 1.78e-62 kg
// and using the [L] = 1 kpc ~ 3.09e19 m as our unit of length results in
// [M] = 1.78e-62 kg and [T] ~ 1.61e11 s ~ 5,100 yr as our unit of time. In
// these units, the gravitational constant is G = 1.05e-108 [L]^3/[M]/[T]^2,
// and a 1e11 solar mass halo contains N = 1.12e103 particles. Rescaling using
// k^2 = 1e-105 yields G = 0.0112 and N = 0.00105. The angular velocity should
// be less than the circular orbital angular velocity, \omega < \sqrt{GM/R^3},
// or \omega < 1.176e-5 / R.
//
// The Compton-wavelength of an 1e-26 eV particle is about 4 kpc; the
// spatial resolution must, therefore, be at least 2 kpc.
//
...
const Float c = 0.0;//4 * pi * a;				// BEC interaction coupling strength
